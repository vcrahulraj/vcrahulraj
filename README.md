...
- Completed a six-month SOC-focused internship covering security monitoring and IBM QRadar SIEM fundamentals.
- Practiced DMZ design, server setup, and router and switch configuration through lab projects.

## Professional Impact

- Shortened monthly IAM audit reporting from roughly **three to four days to a few hours** with an internal web application now used by the four-member project team.
- Reduced employee-transfer case preparation from about **45 minutes to five minutes** through a rule-based workflow for SailPoint exports, Excel formatting, and email drafting.
- Built a web-based PowerShell command generator for bulk Exchange shared-mailbox permissions, including Full Access, Send As, and Send on Behalf.

## Skills

**Identity and access:** SailPoint IdentityIQ, identity lifecycle operations, entitlement reviews, access governance, Active Directory, Okta, ServiceNow
...
> Both projects are independent portfolio prototypes built with fictional data. They are not connected to employer or client systems and cannot execute access changes or remediation.

## Contact

[Portfolio](https://vcrahulraj.github.io/) · [GitHub](https://github.com/vcrahulraj) · [Email](mailto:vcrahulraj@gmail.com)
